...
FAVICON_PLACEHOLDER = "__IMMICH" + "_REVIEW_ICON_SVG__"
FAVICON_SVG = """__IMMICH_REVIEW_ICON_SVG__"""
if FAVICON_SVG.strip() == FAVICON_PLACEHOLDER:
    FAVICON_SVG = Path(__file__).with_name("icon.svg").read_text(encoding="utf-8")
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_GET(self):
            ...
            if parsed.path == "/healthz":
                ...
                return
            if parsed.path in ("/favicon.svg", "/icon.svg"):
                self.send_text(HTTPStatus.OK, FAVICON_SVG, "image/svg+xml; charset=utf-8")
                return
